								...
								<td>
									<div>
										<font size="2" face="Verdana">
											<input style="BORDER-BOTTOM: #808080 6pt; BORDER-LEFT: #808080 6pt; BACKGROUND-COLOR: #ebf0f9; WIDTH: 227px; HEIGHT: 31px; BORDER-TOP: #808080 6pt; BORDER-RIGHT: #808080 6pt" class="langFont" title="" value="Datos Generales" size="15" type="button" xd:CtrlId="btTab1" xd:xctname="Button" tabIndex="0"/>
										</font>
									</div>
								</td>
								<td>
									<div>
										<font size="2" face="Verdana">
											<input style="BORDER-BOTTOM: #808080 6pt; BORDER-LEFT: #808080 6pt; BACKGROUND-COLOR: #ebf0f9; WIDTH: 204px; HEIGHT: 32px; BORDER-TOP: #808080 6pt; BORDER-RIGHT: #808080 6pt" class="langFont" title="" value="Estructura" size="29" type="button" xd:CtrlId="btTab2" xd:xctname="Button" tabIndex="0"/>
										</font>
									</div>
								</td>
								<td>
									<div>
										<font size="2" face="Verdana">
											<input style="BORDER-BOTTOM: #808080 6pt; BORDER-LEFT: #808080 6pt; BACKGROUND-COLOR: #d1ddf1; WIDTH: 214px; HEIGHT: 31px; BORDER-TOP: #808080 6pt; BORDER-RIGHT: #808080 6pt" class="langFont" title="" value="Reglas" size="40" type="button" xd:CtrlId="btTab3" xd:xctname="Button" tabIndex="0"/>
										</font>
									</div>
								</td>
							</tr>
							<tr style="MIN-HEIGHT: 483px">
								<td style="BACKGROUND-COLOR: #cbd8eb" colSpan="3">
									<div>
										<font size="2" face="Verdana">Tab 3</font>
									</div>
								</td>
							</tr>
						</tbody>
