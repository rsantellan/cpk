<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MantenimientoProductoVersionado.aspx.cs"
...
<head runat="server">
    <title>Versionado de Productos</title>
            ...
            <div class="consulta">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownListAutores" runat="server" 
                                DataSourceID="SqlDataSourceAutoresVersionaProductos" DataTextField="Autor" 
                                DataValueField="Autor">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSourceAutoresVersionaProductos" runat="server" 
                ...
                <div>
                    <asp:GridView ID="GridViewDatos" runat="server" AllowPaging="True" 
                        ...
                        <Columns>
                            <asp:HyperLinkField HeaderText="Modificar" DataNavigateUrlFields="Id" DataNavigateUrlFormatString="InsertarProducto.aspx?id={0}"
