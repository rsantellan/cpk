...
public class WebServiceFlia  : System.Web.Services.WebService {
  ...
  [WebMethod]
   public decimal GetProductUltimoID(string pUsuario)
    {
        ...
        var query = 
            from t in
            (from t in db.ProductoInformacionGeneral
            where
              t.Usuario == pUsuario
            select new {
              t.Id,
        ...
        System.IO.StreamWriter sw1 = new System.IO.StreamWriter("c:\\temp\\dbconnProducto.txt", true);
