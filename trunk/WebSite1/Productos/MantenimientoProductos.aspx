<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MantenimientoProductos.aspx.cs" Inherits="MantenimientoAtributos" %>
...
<ul id="nav">
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td class="style2">
                &nbsp;</td>
            <td>
                <asp:Label ID="LabelProducto" runat="server" Text="Producto" Font-Bold="True"></asp:Label>
            </td>
            ...
            <td class="style1">
             ...
             <td class="style1">
                 ...
                 <asp:SqlDataSource ID="SqlDataSourceAutoresProducto" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT [Autor] FROM [ProductoInformacionGeneral]">
                 </asp:SqlDataSource>
    ...
    <div class="consulta">
        <asp:GridView ID="GridViewDatos" runat="server" AutoGenerateColumns="False" 
            ...
            CssClass="results" >
            <Columns>
                <asp:HyperLinkField HeaderText="Modificar" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="InsertarProducto.aspx?id={0}" DataTextField="ModificarMostrar"/>
                <asp:HyperLinkField HeaderText="Versionado" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="MantenimientoProductoVersionado.aspx?id={0}" DataTextField="VersionadoMostrar"/>
                ...
                <asp:HyperLinkField HeaderText="" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="InsertarProducto.aspx?id={0}&ver=1" DataTextField="VersionadoMostrar"/>
