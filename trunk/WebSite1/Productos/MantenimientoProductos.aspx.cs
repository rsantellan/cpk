...
public partial class MantenimientoAtributos : System.Web.UI.Page
{
    ...
    private void cargarDatos()
    {
        ...
        DataSet datos = abmc.searchProduct(this.TextBoxFamilia.Text, estado, this.DropDownListAutores.SelectedValue.ToString(), " ", version, vigenciaDesde, vigenciaHasta, vigenciaFinDesde, vigenciaFinHasta, creacionDesde, creacionHasta);
