<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RevisionProducto.aspx.cs"
                        ...
                        <td>
                            <table>
                                ...
                                <tr>
                                    <td>18-40</td>
                                    <td>F</td>
                                    <td><asp:TextBox ID="TextBoxFemeninoAdulto" runat="server" ReadOnly="True"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td>41-70</td>
                                    <td>F</td>
                                    <td><asp:TextBox ID="TextBoxFemeninoAdultoMayor" runat="server" ReadOnly="True"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td>18-40</td>
                                    <td>M</td>
                                    <td><asp:TextBox ID="TextBoxMasculinoAdulto" runat="server" ReadOnly="True"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td>41-70</td>
                                    <td>F</td>
                                    <td><asp:TextBox ID="TextBoxMasculinoAdultoMayor" runat="server" ReadOnly="True"></asp:TextBox></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
