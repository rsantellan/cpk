...
public partial class Atributos : System.Web.UI.Page
{
    ...
    {
        this.TextBoxCalendarDesde.Text = CalendarDesde.SelectedDate.ToShortDateString();
    }
    protected void CalendarHasta_SelectionChanged(object sender, EventArgs e)
    {
        this.TextBoxCalendarHasta.Text = CalendarHasta.SelectedDate.ToShortDateString();
    }
